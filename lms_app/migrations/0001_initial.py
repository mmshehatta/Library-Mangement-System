    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_img', models.ImageField(blank=True, null=True, upload_to='books_pics')),
                ('author_img', models.ImageField(blank=True, null=True, upload_to='author_pics')),
                ...
                ('status', models.CharField(choices=[('a', 'available'), ('r', 'rental'), ('sold', 'sold')], max_length=50)),
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='lms_app.author')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='book',
            name='language',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='lms_app.language'),
        ),
    ]
